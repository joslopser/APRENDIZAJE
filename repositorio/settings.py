# Django settings for siova project.
#encoding:utf-8
...
EXE_ROOT = os.path.join(RUTA_PROYECTO, 'ejecutables')
...
SECRET_KEY = 'x7ie@f7dejkz2z_k75@y6gt%uc=wtfv*5wyr+v=qk=w_90l24('
